...
# GIT REPO
LUNAREP="https://raw.githubusercontent.com/RIFQISTORE/elzzscripts/main/"
...
PW_DEFAULT() {
    ...
    local password_url="https://raw.githubusercontent.com/RIFQISTORE/elzzscripts/main/configure/password"
...
LIMIT_HANDLER() {
    ...
    wget https://raw.githubusercontent.com/RIFQISTORE/elzzscripts/main/LimitHandler/install.sh && chmod +x install.sh && ./install.sh
...
MENU_SETUP() {
    ...
    wget https://raw.githubusercontent.com/RIFQISTORE/elzzscripts/main/feature/LUNAVPN
    unzip LUNAVPN
    chmod +x menu/*
